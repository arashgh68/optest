<form action="<?php echo base_url('admin/course/edit_course/'.$course_id); ?>" method="post">
    <div class='container'>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="course_title" class="form-control" placeholder="عنوان درس"
                            name="course[title]" value="<?php echo $course_data[0]->title ?>" required
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea type="text" class="summernote" name="course[description]"
                            placeholder="توصبف درس"><?php echo $course_data[0]->description ?></textarea>
                    </div>
                </div>
            </div>
        </div>
